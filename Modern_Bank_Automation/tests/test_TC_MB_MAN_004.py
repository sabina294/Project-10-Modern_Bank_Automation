...
def test_tc_mb_man_004(browser_config, test_case):
    logging.info("TC_MB_MAN_004 Started..")
    logging.info(test_case["manager"][3]["TC_MAN_004"]["_comment"])
    ...
    try:
        manager_registration_page.enter_manager_fullname(test_case["manager"][3]["TC_MAN_004"]["fullname"])
    ...
    try:
        manager_registration_page.enter_manager_email(test_case["manager"][3]["TC_MAN_004"]["email"])
    ...
    try:
        manager_registration_page.enter_manager_password(test_case["manager"][3]["TC_MAN_004"]["pass"])
    ...
    expected_error_message = test_case["manager"][3]["TC_MAN_004"]["expected_result"]
