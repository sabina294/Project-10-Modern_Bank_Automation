...
def test_tc_mb_man_003(browser_config, test_case):
    ...
    try:
        manager_registration_page.enter_manager_fullname(test_case["manager"][2]["TC_MAN_003"]["fullname"])
    ...
    try:
        manager_registration_page.enter_manager_email(test_case["manager"][2]["TC_MAN_003"]["email"])
    ...
    try:
        manager_registration_page.enter_manager_password(test_case["manager"][2]["TC_MAN_003"]["pass"])
    ...
    expected_error_message = test_case["manager"][2]["TC_MAN_003"]["expected_result"]
    ...
    if expected_error_message == manager_registration_page.get_html_popup_error_message("Email"):
        ...
        # Screenshot
        capture_full_page_screenshot(driver, "TC_MB_MAN_003")

    logging.info("TC_MB_MAN_003 Completed..")