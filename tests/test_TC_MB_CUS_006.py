...
def test_tc_mb_cus_006(browser_config, test_case):
    logging.info("TC_MB_CUS_006 Started..")
    logging.info(test_case["customer"][5]["TC_CUS_006"]["_comment"])
    ...
    try:
        customer_registration_page.enter_customer_fullname(test_case["customer"][5]["TC_CUS_006"]["fullname"])
    ...
    try:
        customer_registration_page.enter_customer_email(test_case["customer"][5]["TC_CUS_006"]["email"])
    ...
    try:
        customer_registration_page.enter_customer_password(test_case["customer"][5]["TC_CUS_006"]["pass"])
    ...
    try:
        customer_registration_page.enter_customer_ini_deposit(test_case["customer"][5]["TC_CUS_006"]["deposit_amount"])
    ...
    expected_error_message = test_case["customer"][5]["TC_CUS_006"]["expected_result"]
    actual_message =customer_registration_page.get_customer_reg_message()

    if expected_error_message == actual_message:
