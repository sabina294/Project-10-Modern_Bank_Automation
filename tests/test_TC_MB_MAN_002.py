...
def test_tc_mb_man_002(browser_config, test_case):
    logging.info("TC_MB_MAN_002 Started..")
    logging.info(test_case["manager"][1]["TC_MAN_002"]["_comment"])
    ...
    try:
        manager_registration_page.enter_manager_fullname(test_case["manager"][1]["TC_MAN_002"]["fullname"])
    ...
    # 4. Enter empty value of Email
    try:
        manager_registration_page.enter_manager_email(test_case["manager"][1]["TC_MAN_002"]["email"])
        logging.info("Empty Email Enter successfully.")
    except Exception as e:
    ...
    try:
        manager_registration_page.enter_manager_password(test_case["manager"][1]["TC_MAN_002"]["pass"])
    ...
    expected_error_message = test_case["manager"][1]["TC_MAN_002"]["expected_result"]

    if expected_error_message == manager_registration_page.get_html_popup_error_message("Email"):
        ...
        # Screenshot
        capture_full_page_screenshot(driver, "TC_MB_MAN_002")

    logging.info("TC_MB_MAN_002 Completed..")