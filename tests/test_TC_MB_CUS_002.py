...
def test_tc_mb_cus_002(browser_config, test_case):
    logging.info("TC_MB_CUS_002 Started..")
    logging.info(test_case["customer"][1]["TC_CUS_002"]["_comment"])
    ...
    try:
        customer_registration_page.enter_customer_fullname(test_case["customer"][1]["TC_CUS_002"]["fullname"])
    ...
    try:
        customer_registration_page.enter_customer_email(test_case["customer"][1]["TC_CUS_002"]["email"])
    ...
    try:
        customer_registration_page.enter_customer_password(test_case["customer"][1]["TC_CUS_002"]["pass"])
    ...
    try:
        customer_registration_page.enter_customer_ini_deposit(test_case["customer"][1]["TC_CUS_002"]["deposit_amount"])
    ...
    expected_error_message = test_case["customer"][1]["TC_CUS_002"]["expected_result"]
    ...
    if expected_error_message == customer_registration_page.get_html_popup_error_message("Email"):
        ...
        # Screenshot
        capture_full_page_screenshot(driver, "TC_MB_CUS_002")

    logging.info("TC_MB_CUS_002 Completed..")